...
interface ElectricitySVGProps extends SVGProps<SVGSVGElement> {
  accentColor?: string;
  size?: number;
}

export default function ElectricitySVG({
  accentColor = 'yellow',
  size = 32,
  ...props
}: ElectricitySVGProps) {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <rect x="220.279" y="392.93" fill={g100} width="71.442" height="119.07" />
      <rect x="256" y="392.93" fill={g200} width="35.721" height="119.07" />
      <path
        fill={g600}
        d="M452.664,319.749h0.002l-0.025-0.05c-0.167-0.348-0.344-0.687-0.517-1.03L309.977,34.417
      ...
      <path
        fill={ac100}
        d="M256,53.581c3.61,0,5.141,2.892,5.412,3.472c0.208,0.447,0.422,0.889,0.642,1.329l142.149,284.252
      ...
      <path
        fill={ac200}
        d="M404.365,342.957l-0.123-0.244c-0.013-0.026-0.026-0.052-0.039-0.079L262.053,58.382
      ...
      <path
        fill={g600}
        d="M258.491,318.512c-2.83,0-5.559-1.349-7.268-3.74l-48.71-68.195
      ...
      <path
        fill={g700}
        d="M306.268,259.403l-9.742-58.453c-0.719-4.307-4.444-7.462-8.809-7.462H256v124.654
